# Reignhold - Repository Structure
...
api/
├── 📄 build.gradle
└── 📁 src/main/java/dev/ewwegg/capitalclaims/api/
    │
    ├── 📄 CapitalClaimsAPI.java                    # Main API interface
    ├── 📄 CapitalClaimsProvider.java               # API instance provider
    │
    ├── 📁 claim/
...
├── 📄 build.gradle
└── 📁 src/
    ├── 📁 main/java/dev/ewwegg/capitalclaims/
    │   │
    │   ├── 📄 CapitalClaims.java                   # Main mod class, entry point
    │   ├── 📄 CapitalClaimsAPIImpl.java            # API implementation
    │   │
    │   ├── 📁 claim/
    ...
    │   │
    │   ├── 📁 config/
    │   │   ├── 📄 CapitalClaimsConfig.java         # Main configuration
    ...
    │
    └── 📁 test/java/dev/ewwegg/capitalclaims/
        │
        ├── 📁 claim/
...
│   ├── 📁 UI/
│   │   ├── 📁 Custom/
│   │   │   ├── 📄 CapitalClaims.png                # Main texture atlas
│   │   │   ├── 📄 CapitalClaims_Icons.png          # Icon sprites
│   │   │   │
│   │   │   └── 📁 Pages/
│   │   │       │
│   │   │       ├── 📁 claim/
...
│   │   │
│   │   └── 📁 Styles/
│   │       └── 📄 CapitalClaims.style              # Custom style definitions
│   │
│   └── 📁 Sounds/
...
└── 📁 Server/
    ...
    ├── 📁 Audio/
    │   └── 📁 SoundEvents/
    │       └── 📄 capitalclaims.json               # Sound event definitions
    │
    └── 📁 Config/
        └── 📄 capitalclaims-default.json           # Default configuration
```
...
```yaml
# User Permissions
capitalclaims.claim.create          # Create claims
capitalclaims.claim.delete          # Delete own claims
capitalclaims.claim.trust           # Trust other players
capitalclaims.claim.flags           # Modify flags
capitalclaims.claim.subclaim        # Create subclaims
capitalclaims.party.create          # Create parties
capitalclaims.party.invite          # Invite to party
capitalclaims.home.use              # Use home teleport
capitalclaims.home.multiple.<n>     # Multiple homes

# Admin Permissions
capitalclaims.admin.bypass          # Bypass all protection
capitalclaims.admin.claim.other     # Manage others' claims
capitalclaims.admin.blocks          # Modify claim blocks
capitalclaims.admin.party           # Manage all parties
capitalclaims.admin.reload          # Reload configuration
capitalclaims.admin.debug           # Debug commands

# Bonus Permissions
capitalclaims.bonus.blocks.<n>      # Bonus claim blocks
capitalclaims.bonus.claims.<n>      # Bonus claim count
capitalclaims.bonus.expiration      # Extended expiration
```
...
CapitalClaimsAPI.get().canBuild(player, location);

// Get claim at position
Optional<IClaim> claim = CapitalClaimsAPI.get().getClaimAt(location);
