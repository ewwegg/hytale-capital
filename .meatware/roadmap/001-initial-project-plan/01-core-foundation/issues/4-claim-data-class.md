...
- **Claim Identity**: Use UUID for claim ID to avoid collision issues
...
- [HytaleDocs - Server Internals](https://hytale-docs.com/docs/api/server-internals) — Data class design patterns
