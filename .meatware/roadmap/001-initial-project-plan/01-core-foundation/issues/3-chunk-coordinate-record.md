...
- **Conversion**: Chunk X = blockX >> 4, Chunk Z = blockZ >> 4 (16x16 chunk columns)
- **Java Record**: Must use Java record syntax for automatic equals/hashCode
- **World Identifier**: Use string world name for multi-world support
...
- [HytaleDocs - Server Internals](https://hytale-docs.com/docs/api/server-internals) — World and chunk coordinate systems
